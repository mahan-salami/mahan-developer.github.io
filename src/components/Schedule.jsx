...
import sche from '../assets/stats.webp';
      ...
      <div className='flex flex-col md:flex-row items-center justify-between gap-12 md:gap-24'>
        ...
        >
          <motion.img 
            ...
            className=' md:w-3/5 w-full' // اضافه کردن max-w-md برای محدود کردن عرض
        ...
        {/* Text Content (Right) */}
        <motion.div 
          className='md:w-1/2 w-full ml-0 md:ml-20'
          variants={item}
        >
          <motion.p 
